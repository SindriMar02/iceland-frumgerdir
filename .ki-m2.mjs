...
const spots=await page.evaluate(()=>{const g=[...document.querySelectorAll('.parallax--sticky')].map(e=>{const r=e.getBoundingClientRect();return {top:r.top+window.scrollY, span:r.height-e.querySelector('.parallax__header').clientHeight}});return {strata:g[0].top+g[0].span*0.72, strataEnd:g[0].top+g[0].span*0.95, gate:g[1].top+g[1].span*0.85}});console.log(JSON.stringify(spots))
