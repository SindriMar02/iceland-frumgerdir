...
> Quiet, family-run guesthouse on Mýrar in Hornafjörður, south-east Iceland, between Höfn and Jökulsárlón glacier lagoon.
> Kyrrlátt, fjölskyldurekið gistiheimili á Mýrum í Hornafirði, milli Hafnar og Jökulsárlóns.
...
## Food
- Dinner: ordered from the menu in the evening, served in the dining room facing the glacier. Nothing to book ahead; guests say on arrival that they would like to eat.
