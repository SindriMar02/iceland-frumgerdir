...
/* ═════════════════════════════════════════════════════════════════════════
   ...
   re-prefixed tark- (repo law: no imports across page folders).
...
export function Register({ peaks, label }: { peaks: readonly RegisterItem[]; label: string }) {
  ...
  if (reduced) return <div className="tark-skyline is-static">{list(0)}</div>

  return (
    <div className="tark-skyline" ref={containerRef}>
      <motion.div className="tark-skyline-track" style={{ x }}>
