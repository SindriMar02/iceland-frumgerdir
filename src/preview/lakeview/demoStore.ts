/**
 * THE TWO-SIDED DEMO STORE — Lakeview edition.
 *
 * One booking, two screens: a guest requests a night on the redesign, and it
...
const KEY = 'lakeview_demo_bookings_v1'
const CHANNEL = 'lakeview_demo'
