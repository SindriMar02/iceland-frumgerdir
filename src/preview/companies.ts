...
const TANNLAEKNAVAKTIN: PreviewCompany = {
...
PREVIEW_COMPANIES.push(FOSSATUN_ENTRY)
...
import { companyEntry as SVARTLODGE_ENTRY } from './svartlodge/company'
PREVIEW_COMPANIES.push(SVARTLODGE_ENTRY)
