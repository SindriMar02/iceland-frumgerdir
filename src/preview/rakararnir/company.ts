...
export const companyEntry: PreviewCompany = {
  ...
  outreach: {
    subject: 'Hugmynd að vefsíðu, frá viðskiptavini',
    body: `Góðan dag,

Ég heiti Sindri og er einn af viðskiptavinum ykkar, ég fæ klippingu hjá ykkur.

Fyrir stuttu var bent á fyrir mér að þið séuð ekki með vefsíðu, bara Facebook-síðuna. Ég starfa við að hanna vefsíður og hugsaði með mér að þetta gæti kostað ykkur talsvert af viðskiptum: fólk sem leitar að rakara í 101 finnur ykkur illa í Google, og sama á við þegar fólk spyr gervigreindarforrit eins og ChatGPT hvar sé hægt að fá klippingu í miðbænum. Svo er vefsíða líka bara hluti af því að líta faglega út.

Þess vegna settist ég niður og gerði frumgerð að vefsíðu fyrir ykkur, bara til að sýna hvað væri hægt að gera. Þetta kostar ykkur ekkert og því fylgir engin skuldbinding.
