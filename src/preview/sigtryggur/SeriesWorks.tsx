  ...
  return (
    <div className="relative">
      ...
      <ul
        ...
        className={
          layout === 'list'
            ? 'sbb-serie-list mx-auto flex max-w-[880px] list-none flex-col gap-[16vh] px-6 pb-40'
            : `sbb-grid mx-auto grid list-none grid-cols-2 justify-center gap-x-[26px] gap-y-[44px] px-6 pb-40
        ...
        {works.map((w, i) => (
          <li key={w.id} data-work-cell="">
            <button
              type="button"
              onClick={() => onOpen(w.id)}
              className="sbb-cell group block w-full text-left focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-black"
            >
              <span
                className={
                  layout === 'list'
              ...
              >
                <img
                  ...
                  className={
                    layout === 'list'
                      ? 'sbb-thumb block w-full will-change-transform'
                      : 'sbb-thumb block h-full w-full object-contain object-bottom will-change-transform'
                  }
                />
              </span>
              {layout === 'grid' && (
      ...
      >
        <div className="flex items-end justify-between">
          <span
            ref={nameWrapRef}
            className="sbb-display relative inline-block overflow-hidden text-[clamp(24px,2.4vw,34px)] uppercase leading-none tracking-[0em]"
            style={{ lineHeight: 1 }}
          />
