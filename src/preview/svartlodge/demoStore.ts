/**
 * THE TWO-SIDED DEMO STORE — svartlodge edition.
 *
 * One booking, two screens: the guest requests nights on the redesign and it
 * appears in the owner's dashboard as a pending row. localStorage is the store,
...
const KEY = 'svartlodge_demo_bookings_v1'
const CHANNEL = 'svartlodge_demo'
