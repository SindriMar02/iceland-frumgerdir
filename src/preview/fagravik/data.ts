...
export const companyEntry: PreviewCompany = {
  ...
  outreach: {
    ...
    body:
      "Sælar Auður og Soffía,\n\nÉg heiti Sindri og hanna vefsíður fyrir íslensk fyrirtæki.\n\nÞað er eitthvað sérstakt við Fögruvík. Að sitja í heitum potti á meðan miðnætursólin sest yfir Eyjafirði, eða horfa á snjóinn leggjast yfir fjöllin hinum megin við fjörðinn. Gestirnir finna það líka. Þið eruð með 8,8 úr 229 umsögnum á Booking.com og 9,5 fyrir staðsetninguna, og Auður hefur verið gestgjafi á Airbnb í tíu ár og er Ofurgestgjafi. Það er ekki sjálfgefið.\n\nÞess vegna fannst mér synd að sjá fagravik.is. Gestur sem heillast af myndunum og leitar ykkur uppi lendir á síðu með myndum frá 2019, án dagatals og verðs, þar sem eina leiðin til að bóka er að smella á umslag og senda tölvupóst. Í síma þarf líka að skruna til hliðar. Þá er auðveldast að bóka í gegnum Booking.com eða Airbnb, og af hverri slíkri bókun fer þóknun til þeirra en ekki til ykkar.\n\nSvo ég settist niður og hannaði frumgerð að nýjum vef sem gerir Fögruvík þau skil sem hún á skilið. Þetta kostar ykkur ekki neitt og því fylgir engin skuldbinding.\n\nHana má skoða hér hvenær sem er, og hún virkar vel í síma:\n[HLEKKUR Á FRUMGERÐ]\n\nÞar tekur miðnætursólin á móti gestinum. Hann segir hversu mörg þau eru og sér strax hvaða hús henta, með ykkar eigin myndum af hverju húsi og af flóanum sumar og vetur, og velur dagsetningar beint á síðunni.\n\nÉg sé líka um hýsingu, viðhald og uppfærslur á síðum sem ég geri, og get tengt bókanir beint við vefinn svo gestir bóki hjá ykkur sjálfum og þóknunin verði eftir hjá ykkur.\n\nEf ykkur líst vel á þetta gæti ég klárað vefinn í heild, en ef ekki er það að sjálfsögðu allt í lagi.\n\nEndilega látið mig vita hvað ykkur finnst.\n\nBestu kveðjur,\nSindri Már\n845-1758\nsndrstudio.is",
  },
}
