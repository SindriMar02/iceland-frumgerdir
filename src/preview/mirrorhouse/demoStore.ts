/**
 * THE TWO-SIDED DEMO STORE — Mirror House edition.
 *
 * One booking, two screens: the guest requests a night on the redesign, and
 * it appears in the owner's dashboard as a pending item. That single loop
 ...
 * (Lineage: fossatun/demoStore.ts, unchanged except the keys.)
 */

import type { Booking } from '../../booking/types'

const KEY = 'mirrorhouse_demo_bookings_v1'
const CHANNEL = 'mirrorhouse_demo'
