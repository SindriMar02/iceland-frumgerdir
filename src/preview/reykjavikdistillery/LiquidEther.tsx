...
export default function LiquidEther({
  ...
  gl_Position = vec4(pos, 1.0);
        ...
        super({
          material: {
            ...
            uniforms: {
              ...
              velocity: { value: simProps.src_v.texture }, px: { value: simProps.cellScale },
    ...
    class WebGLManager {
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      props: any; output: any; autoDriver: any
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    if (import.meta.env.DEV) (window as any).__liquidEther = { webgl, Mouse, Common }
