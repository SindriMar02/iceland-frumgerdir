/**
 * THE TWO-SIDED DEMO STORE — Laxfoss edition.
 *
 * One booking, two screens: the guest requests nights on the redesign and it
 * appears in Guðlaug's dashboard as a pending row. localStorage is the store,
...
const KEY = 'laxfoss_demo_bookings_v1'
const CHANNEL = 'laxfoss_demo'
