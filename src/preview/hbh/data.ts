...
export const companyEntry: PreviewCompany = {
  ...
  outreach: {
    ...
    body:
      'Sælir,\n\n' +
      'Ég heiti Sindri og hanna vefsíður fyrir íslensk fyrirtæki. Ég rakst á hbh.is og það sem sat eftir voru verkin sjálf, Canopy, Sandhótel, Smárabíó, Nauthóll og Marel. Myndirnar af þeim eru virkilega góðar og það er ekki sjálfgefið að verktaki eigi svona myndefni af sínum eigin verkum.\n\n' +
      'Mér fannst samt leitt að sjá hvað verkin fá lítið pláss. Þau eru ein málsgrein neðst á forsíðunni, myndirnar liggja á undirsíðu án þess að nöfnin fylgi þeim og ekkert verk á sína eigin síðu. Sá sem er að velja verktaka í hótel, veitingastað eða atvinnuhúsnæði er einmitt að leita að þessu, og eins og staðan er finnur hann hvorki Canopy né Sandhótel í leit, því hvergi á vefnum er texti um þau sem leitarvélar geta sýnt. Þannig geta fyrirspurnir farið forgörðum án þess að nokkur taki eftir því.\n\n' +
      'Tvennt tæknilegt fylgir svo með, og hvort tveggja lagast í leiðinni þegar vefur er endurgerður. Vefurinn keyrir enn á WordPress 5.4.21 sem kom út í apríl 2020 og hefur ekki fengið öryggisuppfærslu síðan, og hbh.is fer ekki sjálfkrafa yfir í https, þannig að vafrar merkja síðuna sem óörugga áður en gestur sér nokkuð.\n\n' +
