...
const en = {
  ...
  reviews: {
    ...
    sourceNote: ', harvested 25 August 2026. Twenty-four of 2,268 — the full set, critical ones included, is on Booking.',
...
const is: typeof en = {
  ...
  reviews: {
    ...
    sourceNote: ', sóttar 25. ágúst 2026. Tuttugu og fjórar af 2.268 — allar umsagnirnar, líka þær gagnrýnu, eru á Booking.',
