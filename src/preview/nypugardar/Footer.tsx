...
export default function Footer({
  ...
  return (
    ...
    >
      <div className="mx-auto grid max-w-6xl gap-12 px-5 pb-12 pt-16 md:grid-cols-12 md:gap-8 md:px-8 md:pt-20">
        ...
        <div className="md:col-span-3">
          ...
          <address className="mt-4 not-italic leading-relaxed text-[#F4EEE2]/80">{ADDRESS}</address>
        ...
        <nav aria-label={t.footer.pages} className="md:col-span-3 md:col-start-10">
