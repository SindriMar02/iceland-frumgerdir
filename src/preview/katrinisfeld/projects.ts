...
export const PROJECTS: Project[] = [
  /* ── Innanhússhönnun ─────────────────────────────────────────────────── */
  {
    ...
    photos: [
      ...
      P('k-nybyggt-hus-i-suluhofda-03', 'Eldhús með vínrauðri eyju og útsýni út um gólfsíða glugga'),
      P('s-skapur', 'Innbyggður glerskápur með lýsingu og dökkum viðaráferðum'),
      P('k-nybyggt-hus-i-suluhofda-05', 'Vaskur í dökkri borðplötu og útsýni út um gluggann'),
      P('k-nybyggt-hus-i-suluhofda-06', 'Dökk steinborðplata og útsýnið fyrir utan'),
      P('k-nybyggt-hus-i-suluhofda-07', 'Vínrauð eyja og hengiljós við langan glugga'),
      P('s-arinn', 'Arinveggur úr ljósum steini með eldiviðarhólfum og faldri lýsingu'),
      P('k-nybyggt-hus-i-suluhofda-09', 'Arinn og steinveggur með falinni lýsingu'),
      ...
      P('k-nybyggt-hus-i-suluhofda-12', 'Fataherbergi með slám, skúffum og lýsingu í lofti'),
      P('s-bad', 'Baðherbergi með bogadregnum lýstum spegli og steinvaski'),
      P('k-nybyggt-hus-i-suluhofda-14', 'Baðherbergi með baklýstum spegli, skál á dökkri plötu og sturtu'),
      P('k-nybyggt-hus-i-suluhofda-15', 'Háir innbyggðir skápar í gráum lit'),
      P('k-nybyggt-hus-i-suluhofda-16', 'Innbyggðir skápar með opinni hurð við glugga'),
      P('s-sturta', 'Sturturými með dökkum steinvegg og grænni plöntu'),
      P('k-nybyggt-hus-i-suluhofda-18', 'Baðinnrétting með skál, baklýstum spegli og glersturtu'),
    ],
  ...
  },
  {
    ...
    photos: [
      ...
      P('k-sumarhus-i-fljotshlidinni-02', 'Eldhús og stofa sumarhússins með eyju og útsýni'),
      P('f-eyja', 'Dökk eldhúseyja sumarhússins með blómum'),
      P('f-krokur', 'Borðkrókur með bogalampa og útsýni út í hlíðina'),
      P('k-sumarhus-i-fljotshlidinni-05', 'Glerskápur og innrétting úr við'),
      P('f-bitar', 'Borðstofa undir timburbitum með kúpulljósi'),
      P('k-sumarhus-i-fljotshlidinni-08', 'Opin skúffa í innréttingu við glugga'),
      P('k-sumarhus-i-fljotshlidinni-09', 'Borðstofa með löngu viðarborði, hengiljósum og kamínu'),
      P('k-sumarhus-i-fljotshlidinni-10', 'Langt viðarborð undir fléttuðum hengiljósum'),
      P('k-sumarhus-i-fljotshlidinni-11', 'Grænn sófi og púðar við stóra glugga'),
      P('k-sumarhus-i-fljotshlidinni-12', 'Stofa með leðurstól, kamínu og síðum gluggatjöldum'),
      P('k-sumarhus-i-fljotshlidinni-13', 'Kamína á steyptum bekk með blómum og styttu'),
      P('p-fljotshlid-0', 'Forstofa með terrazzógólfi og hornum á vegg'),
      P('k-sumarhus-i-fljotshlidinni-15', 'Gangur með háum skáp og opnum dyrum'),
      ...
      P('k-sumarhus-i-fljotshlidinni-18', 'Handlaug á dökkri plötu og upplýstur spegill'),
      P('k-sumarhus-i-fljotshlidinni-19', 'Fataherbergi með opinni slá og skúffum'),
      P('k-sumarhus-i-fljotshlidinni-20', 'Baðinnrétting með handlaug og spegli við grænar veggflísar'),
      P('k-sumarhus-i-fljotshlidinni-21', 'Baðinnrétting við glugga og steinveggir'),
      P('k-sumarhus-i-fljotshlidinni-22', 'Baðherbergi með opnum dyrum út á gang'),
      P('k-sumarhus-i-fljotshlidinni-23', 'Handlaug og upplýstur spegill við steinvegg'),
      P('k-sumarhus-i-fljotshlidinni-24', 'Sturta með grænum veggflísum og svörtum handklæðaofni'),
      P('k-sumarhus-i-fljotshlidinni-25', 'Sturta með grænum flísum og falinni lýsingu'),
      P('k-sumarhus-i-fljotshlidinni-26', 'Gluggi með mattri filmu af laufum'),
      P('k-sumarhus-i-fljotshlidinni-27', 'Glerhurð með mattri filmu'),
      P('k-sumarhus-i-fljotshlidinni-28', 'Kona stendur við innréttingu í sýningarrými'),
    ],
  ...
  },
  {
    ...
    photos: [
      ...
      P('k-alfheimar-03', 'Tímaritahillur og hvítar hirslur á skrifstofu í Álfheimum'),
      P('k-alfheimar-04', 'Opnar hillur með glösum, bollum og gylltum uglum í Álfheimum'),
      P('p-alfheimar-3', 'Rýmisskil úr opinni hillu með veggfóðri og kertastjökum'),
      P('k-alfheimar-06', 'Eldhús í Álfheimum með eyju, háum stólum og rauðum ísskáp'),
      P('p-alfheimar-2', 'Gangur með dumbrauðum ísskáp, svörtum ofnum og skógarmynd á vegg'),
      P('k-alfheimar-08', 'Rauður ísskápur milli dökkra skápa og ofns í Álfheimum'),
      P('k-alfheimar-09', 'Borðplata og skúffuhöldur í eldhúsinu í Álfheimum'),
      P('p-alfheimar-6', 'Svefnherbergi með bláum vegg, bólstruðum rúmgafli og upprunalegum tekkfataskáp'),
      P('k-alfheimar-11', 'Svartur stóll, koparvasi og málverk af tré í Álfheimum'),
      ...
      P('k-alfheimar-15', 'Kona á svörtum stól fyrir framan stórt málverk í Álfheimum'),
    ],
  ...
  },
  {
    ...
    photos: [
      ...
      P('k-honnunar-studio-03', 'Sýningareldhúsið í stúdíóinu við gluggann með nafni stúdíósins'),
      P('p-studio-4', 'Vinnurými undir beinni steypu með sýnilegum lögnum'),
      P('k-honnunar-studio-05', 'Merki stúdíósins í lit á glugga og fléttaður bekkur'),
      P('k-honnunar-studio-06', 'Merki stúdíósins á glugganum, grænn sófi og dökkur vasi'),
      P('k-honnunar-studio-07', 'Gluggatjald með merki stúdíósins'),
      P('k-honnunar-studio-08', 'Hár dökkur skápaveggur með innbyggðum ofnum í stúdíóinu'),
      P('k-honnunar-studio-09', 'Skápaveggurinn opinn með hillum og ofnum'),
      P('k-honnunar-studio-10', 'Lítil dökk innrétting með vaski og myndum á vegg'),
      P('p-studio-5', 'Fundarhorn með plómurauðum vegg og efnissýnum'),
      P('k-honnunar-studio-12', 'Svartar hillur við koparlitaðan vegg í stúdíóinu'),
      P('p-studio-3', 'Lýstur sporöskjulaga spegill á plómurauðum vegg yfir efnisspjöldum'),
      P('k-honnunar-studio-14', 'Dökk baðinnrétting með kringlóttum spegli og koparvaski'),
      P('k-honnunar-studio-15', 'Dökkur veggur með baðinnréttingu, spegli og mynd'),
      ...
      P('p-studio-6', 'Tveir einstaklingar í stúdíóinu við upplýstan spegil'),
    ],
  ...
  },
  {
    ...
    photos: [
      ...
      P('k-fjallalind-05', 'Stofa og borðstofa með dökku borði, hengiljósi og síðum gluggatjöldum'),
      P('k-fjallalind-06', 'Dökk eldhúsinnrétting við hornglugga og veggklukka'),
      ...
      P('p-fjallalind-6', 'Kona í ljósri peysu í eldhúsinu í Fjallalind'),
    ],
  ...
  },
  {
    ...
    photos: [
      ...
      P('k-fallegt-hus-i-kopavogi-04', 'Bjartur gangur með glerþaki, fatahengi og bleikum stráum'),
...

  {
    ...
    photos: [
      ...
      P('k-sumarhus-i-olfusi-04', 'Eldhús með ísskáp og dökkri innréttingu við viðarþiljur'),
  ...
  },
  {
    ...
    photos: [
      ...
      P('k-arkitektoniskt-kameljon-12', 'Dökkir innbyggðir skápar og opnar dyr inn í næsta herbergi'),
  ...
  },
  {
    ...
    photos: [
      ...
      P('p-freyjalux-5', 'Grár sófi og ljósmynd af hestum á vegg'),
  ...
  },
  {
    ...
    photos: [
      ...
      P('k-old-charm-reykjavik-apartment-01', 'Stigi úr við og rauðmálaður veggur'),
      P('k-old-charm-reykjavik-apartment-03', 'Eldhús og borðstofa með viðarborði og grænbláum stólum'),
      P('k-old-charm-reykjavik-apartment-04', 'Eldhús með hvítri innréttingu og viðargólfi'),
      P('k-old-charm-reykjavik-apartment-05', 'Svefnherbergi með tveimur rúmum og rauðum þiljuvegg'),
      ...
      P('k-old-charm-reykjavik-apartment-08', 'Stofa með gráum sófum og rauðum púðum'),
      ...
      P('k-old-charm-reykjavik-apartment-11', 'Baðherbergi með fjólubláum vegg og hvítum flísum'),
      P('p-oldcharm-6', 'Gangur með upprunalegum múrsteinsstromp'),
      P('p-oldcharm-2', 'Svart bárujárnshús við götuna í miðborginni'),
      P('k-old-charm-reykjavik-apartment-14', 'Gamla timburhúsið að utan'),
  ...
  },
  {
    ...
    photos: [
      ...
      P('k-hotel-hekla-04', 'Handlaug á ljósri plötu og kringlóttur spegill við bláan vegg'),
      P('k-hotel-hekla-05', 'Hótelherbergi með hvítu rúmi undir súð'),
      P('k-hotel-hekla-06', 'Herbergi með sjónvarpi á skilvegg og setustofu'),
      P('p-hekla-1', 'Baðherbergi með appelsínugulum flísavegg og baðkari'),
      P('k-hotel-hekla-08', 'Svartur stóll með púða sem sýnir fugl'),
  ...
  /* ── Atvinnuhúsnæði ──────────────────────────────────────────────────── */
  {
    ...
    photos: [
      ...
      P('k-skrifstofurymi-05', 'Opið rými með borðum og fléttuðu hengiljósi'),
      P('k-skrifstofurymi-06', 'Glerhurð með filmu af greinum og tveir svartir vasar'),
      P('k-skrifstofurymi-07', 'Glerveggur með filmu af plöntum inn í fundarherbergi'),
      P('k-skrifstofurymi-08', 'Svalahurð og stór pottaplanta'),
      P('k-skrifstofurymi-09', 'Glerhurðir með filmu af laufum á gangi'),
      P('k-skrifstofurymi-10', 'Dökkir glerveggir og grænn kollur'),
      P('k-skrifstofurymi-11', 'Glerveggir með blárri filmu af trjágreinum'),
      P('k-skrifstofurymi-12', 'Setustofa með stólum, plöntu og mynd á vegg'),
      P('k-skrifstofurymi-13', 'Setustofa með sófa, rauðum stól og ljósum gluggatjöldum'),
      P('p-skrifstofa-0', 'Setuhorn á skrifstofu með gráum sófa og terracotta stól'),
      P('k-skrifstofurymi-15', 'Gangur með glerhurðum og plöntum'),
      P('k-skrifstofurymi-16', 'Kaffistofa með löngu borði og fléttuðum hengiljósum'),
      P('k-skrifstofurymi-17', 'Langt fundarborð og innrétting við gluggann'),
      P('k-skrifstofurymi-18', 'Rauðbrúnn veggur með falinni lýsingu og lágum bekk'),
      P('k-skrifstofurymi-19', 'Salur með fiskibeinaparketi og fléttuðum ljósum'),
      P('k-skrifstofurymi-20', 'Skrifborð við glerhurð með filmu'),
      P('k-skrifstofurymi-21', 'Vinnuaðstaða með skrifborðsstól og ljósum gluggatjöldum'),
      P('p-skrifstofa-2', 'Merking heilsuseturs á viðarvegg í móttöku'),
      P('k-skrifstofurymi-24', 'Opið vinnurými með bláum vegg og litríkum myndum'),
      P('k-skrifstofurymi-25', 'Setustofa í opnu vinnurými með leðursófum'),
      P('p-skrifstofa-3', 'Fundarrými með plómurauðum veggjum, háu borði og pílukastspjaldi'),
      P('k-skrifstofurymi-27', 'Setustofa með bláum vegg, sófum og sjónvarpi'),
      P('k-skrifstofurymi-28', 'Setustofa með pílukastsspjaldi og bláum vegg'),
      P('k-skrifstofurymi-29', 'Rauðbrúnn veggur og glerveggur inn í skrifstofu'),
      P('k-skrifstofurymi-30', 'Opið vinnurými með fundarborði og rauðbrúnum vegg'),
    ],
  ...
  },
  {
    ...
    photos: [
      ...
      P('k-tannlaeknastofan-gardatorgi-04', 'Móttaka með afgreiðsluborði, sófa og biðstólum'),
  ...
  /* ── Ýmislegt ────────────────────────────────────────────────────────── */
  {
    ...
    photos: [
      ...
      P('k-skrifstofurymi-10', 'Dökkir glerveggir og grænn kollur'),
      P('p-skrifstofa-7', 'Setustofa með fléttuljósi, sófa og gróðurmynstruðum vegg'),
      P('k-stemning-06', 'Merki stúdíósins í lit á glugga og fléttaður bekkur'),
      P('k-skrifstofurymi-08', 'Svalahurð og stór pottaplanta'),
      ...
      P('k-stemning-13', 'Glerhurð með mattri filmu af laufum'),
      P('k-stemning-14', 'Vinnuborð með efnisprufum í stúdíóinu'),
      P('k-stemning-15', 'Gluggi stúdíósins með texta á glerinu að kvöldi'),
      P('k-stemning-16', 'Hurð með áletruninni Hönnun er upplifun'),
      P('k-stemning-17', 'Rimlaskilrúm úr dökkum við og ljós gluggatjöld'),
      P('k-stemning-18', 'Rimlaskilrúm úr dökkum við við borðstofuna'),
      P('k-stemning-19', 'Rimlaskilrúm úr dökkum við'),
      P('k-stemning-20', 'Nærmynd af dökkum viðarrimlum'),
      P('k-stemning-21', 'Lágur skápur með bókum og málverk á vegg'),
      P('k-stemning-22', 'Upplýstar hillur yfir lágum skáp með bókum og kertum'),
      ...
      P('p-barnaherbergi-0', 'Barnaherbergi þar sem blágrænn litur er á bæði veggjum og lofti'),
      P('p-eldhus107-4', 'Stofan sem deilir rými með eldhúsinu'),
      P('k-stemning-33', 'Snyrting með bláum og brúnum flísum, skál og upplýstum spegli'),
      P('p-freyjalux-3', 'Snyrting með sexhyrndum flísum, lýstum sporöskjuspegli og dökkbláum dyrum'),
      P('k-stemning-35', 'Svartur stóll, koparvasi og málverk af tré'),
    ],
