/**
 * THE OWNER'S SIDE — the dashboard Rósa and Snæbjörn would run. Deliberately a separate
 ...
 *
 * In Icelandic, because its audience is Rósa and Snæbjörn.
...
export default function SvartaborgDashboard() {
  ...
  return (
    <div style={{ minHeight: '100svh', background: FROST, color: INK, fontFamily: SANS, fontWeight: 400 }}>
      <style>{`
        @font-face { font-family: 'Familjen Grotesk'; src: url('${import.meta.env.BASE_URL}svartaborg/fonts/FamiljenGrotesk-Regular.woff2') format('woff2'); font-weight: 400; font-display: swap; }
        @font-face { font-family: 'Familjen Grotesk'; src: url('${import.meta.env.BASE_URL}svartaborg/fonts/FamiljenGrotesk-Medium.woff2') format('woff2'); font-weight: 500; font-display: swap; }
      ...
      <div className="sbd-focus" style={{ maxWidth: 880, margin: '0 auto', padding: '40px 20px 80px' }}>
        <header style={{ display: 'flex', alignItems: 'baseline', gap: 18, flexWrap: 'wrap' }}>
          ...
          <Link to="/preview/svartaborg" style={{ marginLeft: 'auto', color: MUTE, fontSize: 13 }}>
            Aftur á gestasíðuna
          </Link>
        </header>
        ...
        {shown.length === 0 ? (
          <div style={{ padding: '56px 0', color: MUTE, fontSize: 15, lineHeight: 1.6 }}>
            ...
            <p style={{ margin: '10px 0 0' }}>
              Farðu á <Link to="/preview/svartaborg">gestasíðuna</Link>,
