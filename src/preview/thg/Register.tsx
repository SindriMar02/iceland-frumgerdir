...
/* ═════════════════════════════════════════════════════════════════════════
   ...
   re-prefixed thg- (repo law: no imports across page folders).
...
export function Register({ peaks, label }: { peaks: readonly RegisterItem[]; label: string }) {
  ...
  if (reduced) return <div className="thg-skyline is-static">{list(0)}</div>

  return (
    <div className="thg-skyline" ref={containerRef}>
      <motion.div className="thg-skyline-track" style={{ x }}>
