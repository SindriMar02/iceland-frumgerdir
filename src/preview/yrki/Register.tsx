...
/* ═════════════════════════════════════════════════════════════════════════
   ...
   re-prefixed yrki- (repo law: no imports across page folders).
...
export function Register({ peaks, label }: { peaks: readonly RegisterItem[]; label: string }) {
  ...
  if (reduced) return <div className="yrki-skyline is-static">{list(0)}</div>

  return (
    <div className="yrki-skyline" ref={containerRef}>
      <motion.div className="yrki-skyline-track" style={{ x }}>
