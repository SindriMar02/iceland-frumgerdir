...
export default function Page() {
  ...
  useEffect(() => {
    ...
    /* FOUT guard (Sindri saw it on his phone): the chars stay masked until
       Boska has actually loaded, otherwise the Georgia fallback flashes a
       visibly bolder wordmark for a beat before the swap. Capped at 900ms so
       the preloader can never become load-bearing on a slow connection. */
