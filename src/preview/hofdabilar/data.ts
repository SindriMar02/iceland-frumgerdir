...
export const CARS: Car[] = [
  { make: 'LAND ROVER', model: 'RANGE ROVER HSE P460 PHEV', reg: '4/2025', priceNum: 24800000, tilbod: true, anVsk: false, km: '15 þ.km', fuel: 'Bensín / Rafmagn', gear: 'Sjálfskipting', href: CD(118053), img: A('rangerover.webp'), img2: A('rangerover.webp'), alt: 'Silfurgrár Land Rover Range Rover HSE P460 PHEV fyrir framan sýningarsal Höfðabíla' },
  { make: 'TOYOTA', model: 'LAND CRUISER LUXURY PANORAMA 37" DEKK', reg: '12/2024', priceNum: 21900000, tilbod: false, anVsk: false, km: '25 þ.km', fuel: 'Dísel', gear: 'Sjálfskipting', href: CD(359065), img: A('landcruiser.webp'), img2: A('landcruiser-b.webp'), alt: 'Hvítur Toyota Land Cruiser á 37 tommu dekkjum fyrir utan Höfðabíla' },
  { make: 'LAND ROVER', model: 'DEFENDER P400E HSE X-DYNAMIC PHEV', reg: '2026', priceNum: 17990000, tilbod: false, anVsk: false, km: null, fuel: 'Bensín / Rafmagn', gear: 'Sjálfskipting', href: CD(103656), img: A('defender.webp'), img2: A('defender-b.webp'), alt: 'Nýr grár Land Rover Defender P400e fyrir framan sýningarsal Höfðabíla' },
  { make: 'BMW', model: 'I5 M60 XDRIVE M-SPORT', reg: '12/2023', priceNum: 12900000, tilbod: false, anVsk: false, km: '47 þ.km', fuel: 'Rafmagn', gear: 'Sjálfskipting', href: CD(122306), img: A('i5.webp'), img2: A('i5-b.webp'), alt: 'Hvítur BMW i5 M60 xDrive fyrir utan Höfðabíla' },
  { make: 'MERCEDES-BENZ', model: 'EQE 500 SUV 4MATIC', reg: '12/2023', priceNum: 11790000, tilbod: false, anVsk: false, km: '26 þ.km', fuel: 'Rafmagn', gear: 'Sjálfskipting', href: CD(261431), img: A('eqe.webp'), img2: A('eqe-b.webp'), alt: 'Hvítur Mercedes-Benz EQE 500 SUV fyrir framan Höfðabíla' },
  { make: 'TESLA', model: 'MODEL X PLAID 6 SÆTA 1020 HÖ', reg: '8/2023', priceNum: 10990000, tilbod: true, anVsk: false, km: '49 þ.km', fuel: 'Rafmagn', gear: 'Sjálfskipting', href: CD(409370), img: A('modelx.webp'), img2: A('modelx.webp'), alt: 'Hvítur Tesla Model X Plaid með opnar vænghurðir fyrir utan Höfðabíla' },
  { make: 'PORSCHE', model: 'TAYCAN 4 CROSS TURISMO', reg: '8/2021', priceNum: 10490000, tilbod: false, anVsk: false, km: '42 þ.km', fuel: 'Rafmagn', gear: 'Sjálfskipting', href: CD(253257), img: A('taycan.webp'), img2: A('taycan-b.webp'), alt: 'Hvítur Porsche Taycan 4 Cross Turismo fyrir utan sýningarsal Höfðabíla' },
  { make: 'TESLA', model: 'MODEL 3 PERFORMANCE', reg: '9/2024', priceNum: 7390000, tilbod: true, anVsk: false, km: '30 þ.km', fuel: 'Rafmagn', gear: 'Sjálfskipting', href: CD(189991), img: A('model3.webp'), img2: A('model3-b.webp'), alt: 'Grár Tesla Model 3 Performance fyrir framan Höfðabíla' },
  { make: 'MERCEDES-BENZ', model: 'EQC 400 4MATIC EDITION 1886', reg: '9/2021', priceNum: 5900000, tilbod: false, anVsk: false, km: '41 þ.km', fuel: 'Rafmagn', gear: 'Sjálfskipting', href: CD(304510), img: A('eqc1886.webp'), img2: A('eqc1886-b.webp'), alt: 'Grár Mercedes-Benz EQC 400 Edition 1886 á plani Höfðabíla' },
  { make: 'JAGUAR', model: 'F-PACE AWD', reg: '11/2019', priceNum: 5790000, tilbod: false, anVsk: false, km: '89 þ.km', fuel: 'Dísel', gear: 'Sjálfskipting', href: CD(379819), img: A('fpace.webp'), img2: A('fpace.webp'), alt: 'Svartur Jaguar F-Pace AWD fyrir utan Höfðabíla' },
  { make: 'MERCEDES-BENZ', model: 'EQC 400 4MATIC', reg: '1/2021', priceNum: 5790000, tilbod: false, anVsk: false, km: '65 þ.km', fuel: 'Rafmagn', gear: 'Sjálfskipting', href: CD(822542), img: A('eqc400.webp'), img2: A('eqc400-b.webp'), alt: 'Hvítur Mercedes-Benz EQC 400 4Matic á plani Höfðabíla' },
  { make: 'KIA', model: 'NIRO EV FINAL EDITION 64 KWH', reg: '4/2026', priceNum: 4980000, tilbod: true, anVsk: false, km: null, fuel: 'Rafmagn', gear: 'Sjálfskipting', href: CD(252991), img: A('niro.webp'), img2: A('niro-b.webp'), alt: 'Hvítur Kia Niro EV fyrir framan sýningarsal Höfðabíla' },
  { make: 'LAND ROVER', model: 'DISCOVERY HSE', reg: '6/2018', priceNum: 4950000, tilbod: false, anVsk: false, km: '140 þ.km', fuel: 'Dísel', gear: 'Sjálfskipting', href: CD(329681), img: A('discovery.webp'), img2: A('discovery-b.webp'), alt: 'Svartur Land Rover Discovery HSE fyrir utan Höfðabíla' },
  { make: 'MG', model: 'MG4 ELECTRIC 77KW LUXURY 520 KM', reg: '4/2026', priceNum: 4480000, tilbod: true, anVsk: false, km: null, fuel: 'Rafmagn', gear: 'Sjálfskipting', href: CD(234276), img: A('mg4.webp'), img2: A('mg4.webp'), alt: 'Svartur MG4 Electric fyrir framan sýningarsal Höfðabíla' },
  { make: 'MAZDA', model: 'CX-30', reg: '12/2022', priceNum: 3990000, tilbod: true, anVsk: false, km: '38 þ.km', fuel: 'Bensín', gear: 'Sjálfskipting', href: CD(374630), img: A('cx30.webp'), img2: A('cx30.webp'), alt: 'Rauður Mazda CX-30 fyrir utan sýningarsal Höfðabíla' },
  { make: 'CAN-AM', model: 'OUTLANDER MAX XT-P', reg: '3/2022', priceNum: 3950000, tilbod: false, anVsk: false, km: '3.500 km', fuel: 'Bensín', gear: 'Sjálfskipting', href: CD(419602), img: A('canam.webp'), img2: A('canam-b.webp'), alt: 'Svart og gult Can-Am Outlander Max XT-P fjórhjól á plani Höfðabíla' },
  { make: 'LEXUS', model: 'NX300H', reg: '2/2016', priceNum: 3490000, tilbod: true, anVsk: false, km: '120 þ.km', fuel: 'Bensín / Rafmagn', gear: 'Sjálfskipting', href: CD(262092), img: A('nx300h.webp'), img2: A('nx300h.webp'), alt: 'Silfurgrár Lexus NX300h fyrir framan Höfðabíla' },
  { make: 'RENAULT', model: 'TRAFIC LANGUR', reg: '3/2021', priceNum: 2790000, tilbod: true, anVsk: true, km: '147 þ.km', fuel: 'Dísel', gear: 'Beinskipting', href: CD(816355), img: A('trafic.webp'), img2: A('trafic-b.webp'), alt: 'Svartur Renault Trafic sendibíll fyrir utan Höfðabíla' },
  { make: 'LAND ROVER', model: 'RANGE ROVER EVOQUE SE', reg: '7/2016', priceNum: 2650000, tilbod: true, anVsk: false, km: '140 þ.km', fuel: 'Dísel', gear: 'Sjálfskipting', href: CD(224005), img: A('evoque.webp'), img2: A('evoque-b.webp'), alt: 'Svartur Range Rover Evoque SE á plani Höfðabíla' },
  { make: 'HONDA', model: 'HR-V SJÁLFSKIPTUR', reg: '11/2016', priceNum: 1890000, tilbod: false, anVsk: false, km: '107 þ.km', fuel: 'Bensín', gear: 'Sjálfskipting', href: CD(223291), img: A('hrv.webp'), img2: A('hrv.webp'), alt: 'Hvítur Honda HR-V fyrir framan sýningarsal Höfðabíla' },
  { make: 'MITSUBISHI', model: 'OUTLANDER', reg: '2/2017', priceNum: 1590000, tilbod: true, anVsk: false, km: '215 þ.km', fuel: 'Dísel', gear: 'Beinskipting', href: CD(127264), img: A('outlander.webp'), img2: A('outlander.webp'), alt: 'Silfurgrár Mitsubishi Outlander á plani Höfðabíla' },
  { make: 'SKODA', model: 'FABIA COMBI SJÁLFSKIPTUR', reg: '6/2016', priceNum: 1490000, tilbod: true, anVsk: false, km: '112 þ.km', fuel: 'Bensín', gear: 'Sjálfskipting', href: CD(338476), img: A('fabia.webp'), img2: A('fabia.webp'), alt: 'Blár Skoda Fabia Combi fyrir utan Höfðabíla' },
  { make: 'SUZUKI', model: 'GRAND VITARA V6', reg: '4/2009', priceNum: 1490000, tilbod: true, anVsk: false, km: '100 þ.km', fuel: 'Bensín', gear: 'Sjálfskipting', href: CD(398210), img: A('vitara.webp'), img2: A('vitara.webp'), alt: 'Rauðbrúnn Suzuki Grand Vitara V6 fyrir framan Höfðabíla' },
  { make: 'FORD', model: 'FIESTA', reg: '3/2017', priceNum: 990000, tilbod: true, anVsk: false, km: '70 þ.km', fuel: 'Bensín', gear: 'Beinskipting', href: CD(298477), img: A('fiesta.webp'), img2: A('fiesta.webp'), alt: 'Rauður Ford Fiesta á plani Höfðabíla' },
  { make: 'PEUGEOT', model: '3008', reg: '3/2015', priceNum: 790000, tilbod: false, anVsk: false, km: '188 þ.km', fuel: 'Dísel', gear: 'Sjálfskipting', href: CD(340438), img: A('p3008.webp'), img2: A('p3008.webp'), alt: 'Grár Peugeot 3008 fyrir utan sýningarsal Höfðabíla' },
  { make: 'CADILLAC', model: 'DEVILLE', reg: '2/1999', priceNum: 590000, tilbod: true, anVsk: false, km: '130 þ.km', fuel: 'Bensín', gear: 'Sjálfskipting', href: CD(295309), img: A('deville.webp'), img2: A('deville-b.webp'), alt: 'Svartur Cadillac DeVille árgerð 1999 fyrir framan sýningarsal Höfðabíla' },
]
