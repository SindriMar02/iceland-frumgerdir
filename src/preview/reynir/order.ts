...
export const ORDER_T: Record<Lang, OrderCopy> = {
  en: {
    ...
    fieldPhone: 'Phone',
    fieldEmail: 'Email',
    fieldEmailHelp: 'Optional. We send a copy of your request here, and use it if we cannot reach you by phone.',
  ...
  is: {
    ...
    fieldPhone: 'Sími',
    fieldEmail: 'Netfang',
    fieldEmailHelp: 'Valfrjálst. Þú færð afrit af beiðninni sent hingað, og við notum það ef ekki næst í þig í síma.',
