...
// Guesthouse Seljavellir — Höfn í Hornafirði farm guesthouse, "Einn dagur á Seljavöllum" day-cycle concept
const SeljavellirPage = lazy(() => import('./preview/seljavellir/Page'))
// Hotel Langaholt — Snæfellsnes coastal hotel, "Sjóndeildarhringurinn" horizon-line concept
const LangaholtPage = lazy(() => import('./preview/langaholt/Page'))
// Fisk Kompaní — Akureyri fish & deli retailer, "Dagsins afli, loksins á netinu" counter concept
const FiskkompaniPage = lazy(() => import('./preview/fiskkompani/Page'))
// Naustið — Húsavík seafood restaurant, "Gula húsið við höfnina" harbour-approach concept
...
const NypugardarWinter = lazy(() => import('./preview/nypugardar/WinterPage'))
...
const SossaPage = lazy(() => import('./preview/sossa/Page'))
...
const IceherbsPage = lazy(() => import('./preview/iceherbs/Page'))
...
const SvartLodgePage = lazy(() => import('./preview/svartlodge/Page'))
const SvartLodgeDashboard = lazy(() => import('./preview/svartlodge/Dashboard'))
      ...
      <BrowserRouter basename={basename}>
        ...
        <Suspense fallback={null}>
          ...
          <Routes>
            ...
            <Route path="/preview/seljavellir" element={<SeljavellirPage />} />
            <Route path="/preview/langaholt" element={<LangaholtPage />} />
            ...
            <Route path="/preview/nypugardar/vetur" element={<NypugardarWinter />} />
            ...
            <Route path="/preview/sossa" element={<SossaPage />} />
            ...
            <Route path="/preview/iceherbs" element={<IceherbsPage />} />
            ...
            <Route path="/preview/chrislund/skonnun" element={<ChrisLundServicePage slug="skonnun" />} />
            <Route path="/preview/chrislund/litgreining" element={<ChrisLundServicePage slug="litgreining" />} />
            ...
            <Route path="/preview/svartlodge" element={<SvartLodgePage />} />
